    ...
    <div class="row justify-content-center">
        <div class="panel panel-default">
            <div class="panel-heading">
                <label id="board-title">Quadro de Tarefas</label>
                <button class="btn-create btn" data-toggle="modal" data-target="#novaListaModal">Nova lista
                    <i class="fas fa-plus-square"></i>
                </button>
                <button class="btn-nova-tarefa btn-create btn" data-toggle="modal" data-target="#novaTarefaModal">Nova
                    tarefa
                    <i class="fas fa-plus-square"></i>
                </button>
            </div>
                    ...
                    <div id="lanes">
                        <div v-for="(lane,index) in lanes" class="scrolling-wrapper">
                            <div id="a" class="">
                                ...
                                <div style="float:left;"><button type="button" class="btn-delete btn btn-danger btn-xs"
                                        v-on:click="removeElement(index)"><i class="fas fa-trash-alt"></i></button>
                                </div>
                            </div>
                        </div>

                        <!-- MODAL CREATE LANE-->
                        <div class="modal fade" id="novaListaModal" tabindex="-1" role="dialog"
                            aria-labelledby="novaListaModalLabel">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form>
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="nomeLista" name="nomeLista"
                                                    v-on:keypress.enter="addLane">
                                            </div>
                                        </form>
                                    </div>
                                    <div class="modal-footer">
                                        ...
                                        <button type="button" class="btn btn-submit" data-dismiss="modal"
                                            v-on:click="addLane">Salvar</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <!-- MODAL CREATE TASK-->
                        <div class="modal fade" id="novaTarefaModal" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-content">
                                        ...
                                        <form>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select id="id-lane" class="form-control">
                                                    <option v-for="lane in lanes" :value=lane.id>@{{lane.title}}
                                                    </option>
                                                </select>
                                            </div>
                                        </form>
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-default"
                                            data-dismiss="modal">Fechar</button>
                                        <button type="button" class="btn btn-submit" data-dismiss="modal"
                                            v-on:click="addTask">Salvar</button>
                                    </div>
                                </div>
                            </div>
                        </div>
